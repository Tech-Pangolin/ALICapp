...
const SolutionsSection: React.FC = () => {
  return (
    <section className="container" id="solutions">
      <Row>
          <Col xs={12} md={12}>
          <h2 className="fw-bold text-uppercase ms-4">
      ...
      <div className="solutions-layout">
        ...
        <div className="row">
          <div className="col-12">
            ...
            <h3 className="fw-semibold ms-2 ms-lg-5 mb-5">
              OUR SOLUTIONS
            </h3>

          </div>
          <div className="col-12 col-lg-6 ms-2 ms-lg-5 ps-5">
            <div>
              <h3 className="fw-semibold ">LIVE<span style={{ color: '#d4af37', fontWeight: '400', fontStyle: 'italic' }}>BALANCED</span>™</h3>
            ...
            <div>
              <h3 className="fw-semibold ">LOCAL COMMUNITY ENGAGEMENT</h3>
              <p className="text-small">
            ...
            <div>
              <h3 className="fw-semibold ">FINANCIAL LITERACY EDUCATION</h3>
              <p className="text-small">
            ...
            <div>
              <h3 className="fw-semibold ">PURPOSE ALIGNMENT SOLUTION</h3>
              <p className="text-small">
